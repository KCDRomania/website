export default {
  schedule: {
    title: 'Kubernetes Community Days Romania - Event Schedule for April 25, 2024',
    description:
      'Explore the detailed agenda for Kubernetes Community Days in Romania on April 25, 2024. Listen to expert talks, and connect with Kubernetes professionals. Plan your day now!',
  },
  workshops: {
  ...
  team: {
    ...
    description: 'Experience the power of community at the Kubernetes Community Days in Romania!',
  },
  archive: {
    title: 'Kubernetes Community Days Romania 2024 - Event Highlights',
    description:
      'Relive the exciting moments from Kubernetes Community Days Romania 2024. Explore our collection of talk videos and event pictures that capture the best of this event.',
  },
  podcast: {
    title: 'Meet the Speakers of Kubernetes Community Day Romania 2024 Podcast',
    description:
      'Listen in to our exciting Kubernetes Community Day Romania 2024 Podcast to hear from our renowned speakers\n',
  },
  static: ({ title }) => ({
